//
//  ChooseTypeTechViewController.swift
//  VNMM
//
...
class ChooseTypeTechViewController: UIViewController, NavigationControllerCustomDelegate {
...
//        self.view_moto.backgroundColor = ColorUtils.hexStringToUIColor(hex: "#80DEEA")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationControllerCustom.setUpNavigationBar(self, backButton: false, searchButton: true, title: "Chọn loại công nghệ")
    ...
    @IBAction func Action_setInforByCar(_ sender: Any) {
        ...
        vc = UIStoryboard.createTransportViewController()
        vc!.typePost = POST_TYPE.LAPTOP.rawValue
    ...
    @IBAction func Action_setInforByMotoCycle(_ sender: Any) {
        let vc : CreateTransportViewController?
        vc = UIStoryboard.createTransportViewController()
        vc!.typePost = POST_TYPE.PHONE.rawValue
        self.navigationController?.pushViewController(vc!, animated: true)
    }
