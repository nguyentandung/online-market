//
//  CreateMotoCycleViewController.swift
//  VNMM
//
...
class CreateMotoCycleViewController: UIViewController, NavigationControllerCustomDelegate, UINavigationControllerDelegate {
...
//        height_view_information.constant = 0
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationControllerCustom.setUpNavigationBar(self, backButton: false, searchButton: true, title: "Đăng tin xe")
        ...
        ResAPI.sharedInstance.getLinkImage(file_name: fileName, ({ (data, Message) -> Void in
            if(data != nil) {
                ...
                if response.code == 200 {
                    ...
                    if self.imageUploadCount == self.selectedAssets.count{
                        self.createPost()
                    }
//                    self.createPost()
...
extension CreateMotoCycleViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension CreateMotoCycleViewController : UITextViewDelegate {
...
extension CreateMotoCycleViewController: NewFeedImageCollectionViewCellDelegate {
...
extension CreateMotoCycleViewController : VideoCollectionViewCellDelegate {
...
extension CreateMotoCycleViewController : UIImagePickerControllerDelegate {
...
extension CreateMotoCycleViewController : UITextFieldDelegate {
